...
<div class="card">
  <div class="card-header gap-2 d-flex justify-content-end">
    <button class="btn btn-outline-success" name=${taskData.id} onclick="editCard.apply(this, arguments)" >
      <i class="fa-solid fa-pen" name=${taskData.id}></i>
    </button>
    <button class="btn btn-outline-danger" name=${taskData.id} onclick="deleteCard.apply(this, arguments)">
      <i class="fa-solid fa-trash-can" name=${taskData.id}></i>
    </button>
  </div>
  <div class="card-body">
    <img
  ...
  <div class="card-footer">
    <button class="btn btn-outline-primary float-end" name=${taskData.id}>Open Task</button>
  </div>
</div>
</div>`;
};
